'''
AK4US975MSY8WZIZ6K1M
du3AyX7po25ygYGtiYzxPsnDcOzntXU7T8mOlKmM

proinv rtngikkojqhlaogz
'''
...
api = tradeapi.REST(
    'AK9YASRCP68JXUQ1N59T',
    'DW6bz0f284Ajkeh1nSzpSZvP4rEAVphxQaoFQCjN',
    'https://api.alpaca.markets'
)

""" # First, open the API connection PAPER API CONNECTION
api = tradeapi.REST(
    'PKJEH731XV1OGG3RL8KA',
    'RXhachGKVs0r93qrL9UitquYOqUb/qkadgOENZtL'
    'Sfkcp63fhtge1FkweD0LLUe/4E5gpuLEvNIV3cqa',
...
def myEmail_Notify(my_content):
    ...
    msg['From'] = ' kingdomtronics@gmail.com'
    msg['To'] = ' kingdomtronics@gmail.com'
    msg.set_content(my_content) 
    
    with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp:
        smtp.login('kingdomtronics@gmail.com', 'vlmlemuprihppntw') 
